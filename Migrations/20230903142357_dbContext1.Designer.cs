...
namespace TrainingAttendanceAutomation.Infrastructure.Migrations
{
    ...
    [Migration("20230903142357_dbContext1")]
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 9, 3, 17, 23, 57, 56, DateTimeKind.Local).AddTicks(3514),
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2023, 9, 3, 17, 23, 57, 56, DateTimeKind.Local).AddTicks(2768),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2023, 9, 3, 17, 23, 57, 56, DateTimeKind.Local).AddTicks(2786),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Manager"
                        },
                        ...
                        {
                            Id = 3,
                            CreatedTime = new DateTime(2023, 9, 3, 17, 23, 57, 56, DateTimeKind.Local).AddTicks(2787),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Instructor"
                        });
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aa4114ad-4516-4b2a-9b59-7dd95d9ee612"),
                            BirthDate = new DateTime(2023, 9, 3, 17, 23, 57, 56, DateTimeKind.Local).AddTicks(3296),
                            BranchId = 1,
                            CreatedTime = new DateTime(2023, 9, 3, 17, 23, 57, 56, DateTimeKind.Local).AddTicks(3298),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
