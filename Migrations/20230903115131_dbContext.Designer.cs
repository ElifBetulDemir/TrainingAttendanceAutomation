...
namespace TrainingAttendanceAutomation.Infrastructure.Migrations
{
    ...
    [Migration("20230903115131_dbContext")]
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 9, 3, 14, 51, 30, 728, DateTimeKind.Local).AddTicks(2003),
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2023, 9, 3, 14, 51, 30, 728, DateTimeKind.Local).AddTicks(1523),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2023, 9, 3, 14, 51, 30, 728, DateTimeKind.Local).AddTicks(1538),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Manager"
                        },
                        ...
                        {
                            Id = 3,
                            CreatedTime = new DateTime(2023, 9, 3, 14, 51, 30, 728, DateTimeKind.Local).AddTicks(1539),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Instructor"
                        });
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("275c5432-c078-4c70-bc75-fe6bc0a428d5"),
                            BirthDate = new DateTime(2023, 9, 3, 14, 51, 30, 728, DateTimeKind.Local).AddTicks(1902),
                            BranchId = 1,
                            CreatedTime = new DateTime(2023, 9, 3, 14, 51, 30, 728, DateTimeKind.Local).AddTicks(1903),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
