...
namespace TrainingAttendanceAutomation.Infrastructure.Migrations
{
    ...
    [Migration("20230903192743_dbContext 4")]
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 9, 3, 22, 27, 43, 436, DateTimeKind.Local).AddTicks(5575),
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2023, 9, 3, 22, 27, 43, 436, DateTimeKind.Local).AddTicks(4767),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2023, 9, 3, 22, 27, 43, 436, DateTimeKind.Local).AddTicks(4783),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Manager"
                        },
                        ...
                        {
                            Id = 3,
                            CreatedTime = new DateTime(2023, 9, 3, 22, 27, 43, 436, DateTimeKind.Local).AddTicks(4785),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Instructor"
                        });
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b3f8339d-7e4b-4a4f-b2e2-f91520dc2071"),
                            BirthDate = new DateTime(2023, 9, 3, 22, 27, 43, 436, DateTimeKind.Local).AddTicks(5397),
                            BranchId = 1,
                            CreatedTime = new DateTime(2023, 9, 3, 22, 27, 43, 436, DateTimeKind.Local).AddTicks(5399),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
