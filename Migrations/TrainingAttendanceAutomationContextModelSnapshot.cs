...
namespace TrainingAttendanceAutomation.Infrastructure.Migrations
{
    ...
    partial class TrainingAttendanceAutomationContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 9, 4, 21, 40, 24, 649, DateTimeKind.Local).AddTicks(8007),
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2023, 9, 4, 21, 40, 24, 649, DateTimeKind.Local).AddTicks(7699),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2023, 9, 4, 21, 40, 24, 649, DateTimeKind.Local).AddTicks(7709),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Manager"
                        },
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("437617ce-4f3e-44e9-8d8d-a9412d4a3d0a"),
                            BirthDate = new DateTime(2023, 9, 4, 21, 40, 24, 649, DateTimeKind.Local).AddTicks(7938),
                            BranchId = 1,
                            CreatedTime = new DateTime(2023, 9, 4, 21, 40, 24, 649, DateTimeKind.Local).AddTicks(7939),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
