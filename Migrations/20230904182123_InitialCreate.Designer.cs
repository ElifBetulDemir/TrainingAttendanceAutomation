...
namespace TrainingAttendanceAutomation.Infrastructure.Migrations
{
    ...
    [Migration("20230904182123_InitialCreate")]
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 9, 4, 21, 21, 23, 426, DateTimeKind.Local).AddTicks(8435),
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2023, 9, 4, 21, 21, 23, 426, DateTimeKind.Local).AddTicks(8107),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2023, 9, 4, 21, 21, 23, 426, DateTimeKind.Local).AddTicks(8121),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Manager"
                        },
                        ...
                        {
                            Id = 3,
                            CreatedTime = new DateTime(2023, 9, 4, 21, 21, 23, 426, DateTimeKind.Local).AddTicks(8122),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Instructor"
                        });
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7c28f281-3f36-4f98-b1cc-8c9a5a2ecde9"),
                            BirthDate = new DateTime(2023, 9, 4, 21, 21, 23, 426, DateTimeKind.Local).AddTicks(8360),
                            BranchId = 1,
                            CreatedTime = new DateTime(2023, 9, 4, 21, 21, 23, 426, DateTimeKind.Local).AddTicks(8361),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
