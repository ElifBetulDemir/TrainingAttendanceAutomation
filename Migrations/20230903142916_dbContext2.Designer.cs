...
namespace TrainingAttendanceAutomation.Infrastructure.Migrations
{
    ...
    [Migration("20230903142916_dbContext2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 9, 3, 17, 29, 15, 755, DateTimeKind.Local).AddTicks(4846),
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2023, 9, 3, 17, 29, 15, 755, DateTimeKind.Local).AddTicks(4292),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2023, 9, 3, 17, 29, 15, 755, DateTimeKind.Local).AddTicks(4307),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Manager"
                        },
                        ...
                        {
                            Id = 3,
                            CreatedTime = new DateTime(2023, 9, 3, 17, 29, 15, 755, DateTimeKind.Local).AddTicks(4308),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            IsDeleted = false,
                            RoleName = "Instructor"
                        });
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2a051eb2-5db2-45a0-a007-a95c1dab7139"),
                            BirthDate = new DateTime(2023, 9, 3, 17, 29, 15, 755, DateTimeKind.Local).AddTicks(4640),
                            BranchId = 1,
                            CreatedTime = new DateTime(2023, 9, 3, 17, 29, 15, 755, DateTimeKind.Local).AddTicks(4641),
                            CreatedUserId = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("TrainingAttendanceAutomation.Domain.Models.Users", b =>
                {
                    b.HasOne("TrainingAttendanceAutomation.Domain.Models.Branch", "Branches")
                        .WithOne("Users")
                        .HasForeignKey("TrainingAttendanceAutomation.Domain.Models.Users", "BranchId");
